...
def main() -> None:
    ...
    try:
        ...
        logger.info("🔔 Получен сигнал прерывания, ожидаем завершения программы")

    except Exception as e:
        logger.exception(f"⛔ Критическая ошибка программы: {e}")
...
#                 logger.exception(f"Ошибка в упрощенном режиме: {e}")
#
...
def test_email_monitor() -> None:
    ...
    try:
        ...
        logger.exception(f"Критическая ошибка в мониторинге почты: {e}")
...
def test_folder_monitor() -> None:
    ...
    try:
        ...
        # Логируем непредвиденные ошибки и завершаем работу
        logger.exception(f"Критическая ошибка в мониторинге папок: {e}")
        raise  # Повторно вызываем исключение для уведомления вызывающего кода
